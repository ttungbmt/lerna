...
var isJSON = _interopDefault(require('validator/lib/isJSON'));
            ...
            return axios({
              ...
              transformResponse: [function (data) {
                if (isJSON(data)) {
                  ...
                  if (lodashEs.isString(transformResponse)) {
                    return lodashEs.get(result, transformResponse);
                  } else if (lodashEs.isFunction(transformResponse)) {
...
function useFetch(props) {
  ...
  var _useQuery = reactQuery.useQuery([key, {
    url: url,
...
//# sourceMappingURL=react.http.cjs.js.map
