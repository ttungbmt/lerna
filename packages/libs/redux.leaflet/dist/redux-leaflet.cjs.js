...
var marker = _interopDefault(require('leaflet/dist/images/marker-icon.png'));
var marker2x = _interopDefault(require('leaflet/dist/images/marker-icon-2x.png'));
var markerShadow = _interopDefault(require('leaflet/dist/images/marker-shadow.png'));
var React = require('react');
var React__default = _interopDefault(React);
var lodashEs = require('lodash-es');
var reactLeaflet = require('react-leaflet');
var leaflet_wms = require('@ttungbmt/leaflet.wms');
...
function MapContainer(_ref) {
  ...
  }, /*#__PURE__*/React__default.createElement(reactLeaflet.LayersControl, {
    position: "topright"
  }, lodashEs.map(layers, function (_ref2, k) {
    var title = _ref2.title,
        _ref2$active = _ref2.active,
        active = _ref2$active === void 0 ? false : _ref2$active,
        options = _ref2.options;
    return /*#__PURE__*/React__default.createElement(BaseLayer, {
      key: k,
      checked: active,
      name: title
    }, /*#__PURE__*/React__default.createElement(reactLeaflet.TileLayer, options));
  })), children);
}
...
var MapContainer$1 = React.memo(MapContainer);
...
var WMSTileLayer = /*#__PURE__*/function (_GridLayer) {
  ...
  _createClass(WMSTileLayer, [{
    ...
    value: function createLeafletElement(props) {
      ...
      return leaflet_wms.tileWMSLayer(url, options);
    }
  }, {
    ...
    value: function updateLeafletElement(fromProps, toProps) {
      ...
      if (!lodashEs.isEqual(params, prevParams)) {
  ...
  return WMSTileLayer;
}(reactLeaflet.GridLayer);

WMSTileLayer.propTypes = {
  layers: PropTypes.string.isRequired
};
var WMSTileLayer$1 = reactLeaflet.withLeaflet(WMSTileLayer);

Object.defineProperty(exports, 'Popup', {
    enumerable: true,
    get: function () {
        return reactLeaflet.Popup;
    }
});
Object.defineProperty(exports, 'useLeaflet', {
    enumerable: true,
    get: function () {
        return reactLeaflet.useLeaflet;
    }
});
exports.MapContainer = MapContainer$1;
exports.WMSTileLayer = WMSTileLayer$1;
exports.baselayers = layers;
//# sourceMappingURL=redux-leaflet.cjs.js.map
