...
function SpeedDialExamplesPage(props) {
    ...
    //         </span>
    //                 <p className="kt-section__sub">It is enabled here across all devices for demo purposes, but in
    //                     production it could use the <code>isTouch</code> logic to conditionally set the property.</p>
    //             </div>
    //             <div className="kt-section">
    //             </div>
    //         </CodeExample>
